...
public class ModRecipeProvider extends RecipeProvider {
	private static final TagKey<Item> INGOTS_COPPER = TagKey.create(Registries.ITEM, new ResourceLocation("forge:ingots/copper"));
	private static final TagKey<Item> INGOTS_STEEL = TagKey.create(Registries.ITEM, new ResourceLocation("forge:ingots/steel"));
	private static final TagKey<Item> INGOTS_SILVER = TagKey.create(Registries.ITEM, new ResourceLocation("forge:ingots/silver"));
	private static final TagKey<Item> INGOTS_TIN = TagKey.create(Registries.ITEM, new ResourceLocation("forge:ingots/tin"));
	...
	protected void buildRecipes(RecipeOutput recipeOutput) {
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.EMPEROR_CHALICE.get())
				...
				.requires(NBTIngredient.of(true, new ItemStack(ModItems.VOID_TEAR.get())))
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.ENDER_STAFF.get())
				...
				.define('V', NBTIngredient.of(true, new ItemStack(ModItems.VOID_TEAR.get())))
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.GOLD_NUGGET)
				...
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, "gold_nugget"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.HARVEST_ROD.get())
				...
				.define('F', ModItems.FERTILE_ESSENCE.get())
				.define('V', Items.VINE)
				.define('T', NBTIngredient.of(true, new ItemStack(ModItems.VOID_TEAR.get())))
				.define('S', Items.STICK)
				.unlockedBy(HAS_VOID_TEAR_CRITERION, has(ModItems.VOID_TEAR.get()))
				.save(recipeOutput);
	...
	private void registerUncraftingRecipes(RecipeOutput recipeOutput) {
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.BLAZE_ROD, 4)
				...
				.requires(ModItems.MOLTEN_CORE.get())
				.unlockedBy(HAS_MOLTEN_CORE_CRITERION, has(ModItems.MOLTEN_CORE.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "blaze_rod"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.BONE, 5)
				...
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "bone"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.ENDER_PEARL, 3)
				.requires(ModItems.NEBULOUS_HEART.get())
				.unlockedBy(HAS_NEBULOUS_HEART_CRITERION, has(ModItems.NEBULOUS_HEART.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "ender_pearl"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.GHAST_TEAR)
				...
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "ghast_tear"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Items.GLASS_BOTTLE, 6)
				...
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "glass_bottle"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.GOLD_NUGGET, 6)
				...
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "gold_nugget"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.GUNPOWDER, 10)
				...
				.unlockedBy("has_eye_of_the_storm", has(ModItems.EYE_OF_THE_STORM.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "gunpowder_storm_eye"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Items.GUNPOWDER, 6)
				...
				.define('W', ModItems.WITCH_HAT.get())
				.unlockedBy(HAS_WITCH_HAT_CRITERION, has(ModItems.WITCH_HAT.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "gunpowder_witch_hat"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.INK_SAC, 6)
				...
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "ink_sac"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.MAGMA_CREAM, 3)
				.requires(ModItems.MOLTEN_CORE.get())
				.unlockedBy(HAS_MOLTEN_CORE_CRITERION, has(ModItems.MOLTEN_CORE.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "magma_cream"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Items.PACKED_ICE)
				...
				.unlockedBy(HAS_FROZEN_CORE_CRITERION, has(ModItems.FROZEN_CORE.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "packed_ice"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.PRISMARINE_CRYSTALS, 10)
				...
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "prismarine_crystals"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.PRISMARINE_SHARD, 5)
				.requires(ModItems.GUARDIAN_SPIKE.get())
				.unlockedBy(HAS_GUARDIAN_SPIKE_CRITERION, has(ModItems.GUARDIAN_SPIKE.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "prismarine_shard"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Items.REDSTONE, 6)
				...
				.define('W', ModItems.WITCH_HAT.get())
				.unlockedBy(HAS_WITCH_HAT_CRITERION, has(ModItems.WITCH_HAT.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "redstone"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.ROTTEN_FLESH, 6)
				.requires(ModItems.ZOMBIE_HEART.get())
				.unlockedBy(HAS_ZOMBIE_HEART_CRITERION, has(ModItems.ZOMBIE_HEART.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "rotten_flesh"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.SPIDER_EYE, 2)
				...
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "spider_eye"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.STICK, 4)
				.requires(ModItems.WITCH_HAT.get())
				.unlockedBy(HAS_WITCH_HAT_CRITERION, has(ModItems.WITCH_HAT.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "stick"));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.STRING, 6)
				.requires(ModItems.CHELICERAE.get())
				.unlockedBy(HAS_CHELICERAE_CRITERION, has(ModItems.CHELICERAE.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "string"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Items.SUGAR, 6)
				.pattern("WWW")
				.define('W', ModItems.WITCH_HAT.get())
				.unlockedBy(HAS_WITCH_HAT_CRITERION, has(ModItems.WITCH_HAT.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "sugar"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.WITHER_SKELETON_SKULL)
				...
				.unlockedBy(HAS_WITHERED_RIB_CRITERION, has(ModItems.WITHERED_RIB.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, UNCRAFTING_FOLDER + "wither_skeleton_skull"));
	...
	private void registerAlkahestryRecipes(RecipeOutput recipeOutput) {
		...
		CraftingRecipeBuilder.craftingRecipe(INGOTS_COPPER, 8, 5)
				.save(recipeOutput.withConditions(new NotCondition(new TagEmptyCondition(INGOTS_COPPER.location()))), new ResourceLocation("copper_ingot"));
		...
		CraftingRecipeBuilder.craftingRecipe(Tags.Items.GRAVEL, 4, 17).save(recipeOutput, RegistryHelper.getRegistryName(Items.GRAVEL));
		CraftingRecipeBuilder.craftingRecipe(Tags.Items.GUNPOWDER, 8, 3).save(recipeOutput, RegistryHelper.getRegistryName(Items.GUNPOWDER));
		...
		CraftingRecipeBuilder.craftingRecipe(Tags.Items.NETHERRACK, 4, 9).save(recipeOutput, RegistryHelper.getRegistryName(Items.NETHERRACK));
		CraftingRecipeBuilder.craftingRecipe(Tags.Items.OBSIDIAN, 8, 5).save(recipeOutput, RegistryHelper.getRegistryName(Items.OBSIDIAN));
		CraftingRecipeBuilder.craftingRecipe(Tags.Items.SAND, 4, 33).save(recipeOutput, RegistryHelper.getRegistryName(Items.SAND));
		CraftingRecipeBuilder.craftingRecipe(Tags.Items.SANDSTONE, 4, 9).save(recipeOutput, RegistryHelper.getRegistryName(Items.SANDSTONE));
		CraftingRecipeBuilder.craftingRecipe(INGOTS_SILVER, 32, 2)
				.save(recipeOutput.withConditions(new NotCondition(new TagEmptyCondition(INGOTS_SILVER.location()))), new ResourceLocation("silver_ingot"));
		...
		CraftingRecipeBuilder.craftingRecipe(INGOTS_STEEL, 32, 2)
				.save(recipeOutput.withConditions(new NotCondition(new TagEmptyCondition(INGOTS_STEEL.location()))), new ResourceLocation("steel_ingot"));
		CraftingRecipeBuilder.craftingRecipe(INGOTS_TIN, 32, 2)
				.save(recipeOutput.withConditions(new NotCondition(new TagEmptyCondition(INGOTS_TIN.location()))), new ResourceLocation("tin_ingot"));
	}
	...
	private void registerCharmFragmentRecipes(RecipeOutput recipeOutput) {
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOB_CHARM_FRAGMENT.get().getStackFor("minecraft:blaze"))
				.pattern("PPP")
				.pattern("STS")
				.pattern("PPP")
				...
				.unlockedBy(HAS_MOLTEN_CORE_CRITERION, has(ModItems.MOLTEN_CORE.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, MOB_CHARM_FRAGMENTS_FOLDER + "blaze"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOB_CHARM_FRAGMENT.get().getStackFor("minecraft:cave_spider"))
				.pattern("PPP")
				.pattern("STS")
				.pattern("PPP")
				.define('P', ModItems.CHELICERAE.get())
				.define('S', Tags.Items.STRING)
				.define('T', NBTIngredient.of(true, PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.POISON)))
				.unlockedBy(HAS_CHELICERAE_CRITERION, has(ModItems.CHELICERAE.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, MOB_CHARM_FRAGMENTS_FOLDER + "cave_spider"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOB_CHARM_FRAGMENT.get().getStackFor("minecraft:creeper"))
				.pattern("PPP")
				.pattern("STS")
				.pattern("PPP")
				.define('P', ModItems.CATALYZING_GLAND.get())
				.define('S', Tags.Items.GUNPOWDER)
				.define('T', Items.BONE)
				.unlockedBy(HAS_CATALYZING_GLAND_CRITERIION, has(ModItems.CATALYZING_GLAND.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, MOB_CHARM_FRAGMENTS_FOLDER + "creeper"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOB_CHARM_FRAGMENT.get().getStackFor("minecraft:enderman"))
				.pattern("PPP")
				.pattern("SPS")
				.pattern("PPP")
				...
				.unlockedBy(HAS_NEBULOUS_HEART_CRITERION, has(ModItems.NEBULOUS_HEART.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, MOB_CHARM_FRAGMENTS_FOLDER + "enderman"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOB_CHARM_FRAGMENT.get().getStackFor("minecraft:ghast"))
				.pattern("PPP")
				.pattern("STS")
				.pattern("PPP")
				...
				.unlockedBy(HAS_CATALYZING_GLAND_CRITERIION, has(ModItems.CATALYZING_GLAND.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, MOB_CHARM_FRAGMENTS_FOLDER + "ghast"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOB_CHARM_FRAGMENT.get().getStackFor("minecraft:guardian"))
				.pattern("PPP")
				.pattern("STS")
				.pattern("PPP")
				.define('P', ModItems.GUARDIAN_SPIKE.get())
				.define('S', Tags.Items.DUSTS_PRISMARINE)
				.define('T', Items.COD)
				.unlockedBy(HAS_GUARDIAN_SPIKE_CRITERION, has(ModItems.GUARDIAN_SPIKE.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, MOB_CHARM_FRAGMENTS_FOLDER + "guardian"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOB_CHARM_FRAGMENT.get().getStackFor("minecraft:magma_cube"))
				.pattern("PPP")
				.pattern("SSS")
				.pattern("PPP")
				.define('P', ModItems.MOLTEN_CORE.get())
				...
				.unlockedBy(HAS_MOLTEN_CORE_CRITERION, has(ModItems.MOLTEN_CORE.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, MOB_CHARM_FRAGMENTS_FOLDER + "magma_cube"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOB_CHARM_FRAGMENT.get().getStackFor("minecraft:skeleton"))
				.pattern("PPP")
				.pattern("STS")
				.pattern("PPP")
				...
				.unlockedBy("has_rib_bone", has(ModItems.RIB_BONE.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, MOB_CHARM_FRAGMENTS_FOLDER + "skeleton"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOB_CHARM_FRAGMENT.get().getStackFor("minecraft:slime"))
				.pattern("PPP")
				.pattern("SSS")
				.pattern("PPP")
				...
				.define('S', Tags.Items.SLIMEBALLS)
				.unlockedBy(HAS_SLIME_PEARL_CRITERION, has(ModItems.SLIME_PEARL.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, MOB_CHARM_FRAGMENTS_FOLDER + "slime"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOB_CHARM_FRAGMENT.get().getStackFor("minecraft:spider"))
				.pattern("PPP")
				.pattern("STS")
				.pattern("PPP")
				.define('P', ModItems.CHELICERAE.get())
				...
				.unlockedBy(HAS_CHELICERAE_CRITERION, has(ModItems.CHELICERAE.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, MOB_CHARM_FRAGMENTS_FOLDER + "spider"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOB_CHARM_FRAGMENT.get().getStackFor("minecraft:witch"))
				.pattern("PPP")
				.pattern("STS")
				.pattern("PPP")
				...
				.define('T', Items.SPIDER_EYE)
				.unlockedBy(HAS_WITCH_HAT_CRITERION, has(ModItems.WITCH_HAT.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, MOB_CHARM_FRAGMENTS_FOLDER + "witch"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOB_CHARM_FRAGMENT.get().getStackFor("minecraft:wither_skeleton"))
				.pattern("PPP")
				.pattern("STS")
				.pattern("PPP")
				...
				.unlockedBy(HAS_WITHERED_RIB_CRITERION, has(ModItems.WITHERED_RIB.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, MOB_CHARM_FRAGMENTS_FOLDER + "wither_skeleton"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOB_CHARM_FRAGMENT.get().getStackFor("minecraft:zombie"))
				.pattern("PPP")
				.pattern("STS")
				.pattern("PPP")
				...
				.define('T', Items.BONE)
				.unlockedBy(HAS_ZOMBIE_HEART_CRITERION, has(ModItems.ZOMBIE_HEART.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, MOB_CHARM_FRAGMENTS_FOLDER + "zombie"));

		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.MOB_CHARM_FRAGMENT.get().getStackFor("minecraft:zombified_piglin"))
				.pattern("PPP")
				.pattern("STS")
				.pattern("PPP")
				.define('P', ModItems.ZOMBIE_HEART.get())
				...
				.unlockedBy(HAS_ZOMBIE_HEART_CRITERION, has(ModItems.ZOMBIE_HEART.get()))
				.save(recipeOutput, new ResourceLocation(Reference.MOD_ID, MOB_CHARM_FRAGMENTS_FOLDER + "zombified_piglin"));
	}
